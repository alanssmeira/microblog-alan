...
function verificaSenha(string $senhaFormulario, string $senhaBanco){
    /* Usamos a password_verify para comparar as duas senhas:
        a digitada no formulário e a existente no bando de dados. */
if (password_verify($senhaFormulario, $senhaBanco)) {
    /* Se elas forem iguais, então significa que o usuário não mudou nada. Portanto, simplesmente mantemos a senha exixtente. */
